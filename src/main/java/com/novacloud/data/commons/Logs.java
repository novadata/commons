...
public class Logs {
	...
	/**
	 * Using a Custom SecurityManager to get the caller classname. Using the old
	 * reflection approach had some drawbacks:<br/>
	 * 1. From Java7u10 to Javau11 the THREAD_TYPE_DEEP differs (+1) due to
	 * internal Java changes.<br/>
	 * 2. From Java7u40 onwards the method is only supported if
	 * "-Djdk.reflect.allowGetCallerClass" is set on start<br/>
